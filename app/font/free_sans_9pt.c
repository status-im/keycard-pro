...
const uint8_t free_sans_9pt_bitmap[] = {
...
const glyph_t free_sans_9pt_glyphs[] = {
    {0, 0, 0, 5, 0, 1},        // 0x20 ' '
    {0, 2, 13, 6, 2, -12},     // 0x21 '!'
    {4, 5, 4, 6, 1, -12},      // 0x22 '"'
    {7, 10, 12, 10, 0, -11},   // 0x23 '#'
    {22, 9, 16, 10, 1, -13},   // 0x24 '$'
    {40, 16, 13, 17, 1, -12},  // 0x25 '%'
...
const font_t free_sans_9pt = {free_sans_9pt_bitmap, free_sans_9pt_glyphs, 0x20, 0x7e, 17, 22};
