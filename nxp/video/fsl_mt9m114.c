...
static const mt9m114_reg_t mt9m114InitConfig[] = {
    ...
    {MT9M114_VAR_CAM_AET_MAX_FRAME_RATE, 2u, 0x1DFD},             /*  cam_aet_max_frame_rate = 7578 */
    {MT9M114_VAR_CAM_AET_MIN_FRAME_RATE, 2u, 0x1DFD},             /*  cam_aet_min_frame_rate = 7578 */
  ...
  //{MT9M114_VAR_CAM_OUTPUT_FORMAT_YUV, 2u, 0x0038},
    {MT9M114_VAR_CAM_OUTPUT_FORMAT_YUV, 2u, 0x001A},              /*  Must set cam_output_format_yuv_clip for CSI */
  {MT9M114_VAR_CAM_OUTPUT_Y_OFFSET, 1u, 0x10},
  {MT9M114_VAR_CAM_AWB_AWBMODE, 1u, 0x00},
};
...
status_t MT9M114_Init(camera_device_handle_t *handle, const camera_config_t *config)
{
    ...
    else if (config->resolution == (uint32_t)kVIDEO_ResolutionVGA) {
        status = MT9M114_MultiWrite(handle, mt9m114_vga, ARRAY_SIZE(mt9m114_vga));
    }
    else
    {
