...
#define USBD_MANUFACTURER_STRING     "Status"
#define USBD_PID     22352
#define USBD_PRODUCT_STRING     "Keycard Pro"
#define USBD_CONFIGURATION_STRING     "Keycard Pro Conf"
#define USBD_INTERFACE_STRING     "Keycard Pro IF"
