...
void HAL_DCMI_MspInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspInit 0 */
    ...
    */
    ...
    handle_GPDMA1_Channel5.Init.Request = GPDMA1_REQUEST_DCMI;
    ...
    handle_GPDMA1_Channel5.Init.Priority = DMA_HIGH_PRIORITY;
    handle_GPDMA1_Channel5.Init.SrcBurstLength = 60;
    handle_GPDMA1_Channel5.Init.DestBurstLength = 60;
    ...
    __HAL_LINKDMA(hdcmi, DMA_Handle, handle_GPDMA1_Channel5);
...
void HAL_DCMI_MspDeInit(DCMI_HandleTypeDef* hdcmi)
{
  ...
  /* USER CODE END DCMI_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_15|GPIO_PIN_4|GPIO_PIN_8);
